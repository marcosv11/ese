          ...
          <div className="container">
            <div className="">
              <div className="row text-center">
                <TituloPrincipal name="DigX Analyctics Experience - Dashboard CNPJ" />
              </div>

              <div className="row ">
                <div className="col-lg-6 col-md-6 col-sm-6">
                  <CardAcerto descricao="Quantidade de CNPJ's com erro" />
                </div>
                <div className="col-lg-6 col-md-6 col-sm-6">
                  <CardErro descricao="Quantidade de CNPJ's sem erro" />
                </div>

                <div className="col-lg-12 col-md-12 col-sm-12  mb-5">
                  <div className="dov">
                    <p>Distribuição de erros e sucessos CNPJ</p>
                    <hr />
                    <GraficoMaior />
                  </div>
                </div>
              ...
              <div className="row  mt-5">
                <div className="col-lg-3 col-md-3  col-sm-3">
                  <CardSemImg title="Quantidade de CNPJ's com erro"/>
                </div>
                <div className="col-lg-3 col-md-3  col-sm-3">
                  <CardSemImg title="Quantidade de CNPJ's com erro"/>
                </div>
              ...
              <div className="row">
                ...
                <div className="dov col-lg-6 col-md-6  col-sm-6  ">
                  <p>Distribuição de erros e sucessos CNPJ - mobile</p>

                  <hr />
                  <GraficoLateral />
                </div>
                <div className="dov col-lg-6 col-md-6  col-sm-6">
                  <p>Distribuição de erros e sucessos CNPJ - internet</p>
                  <hr />
                  <GraficoLateral />
                </div>
              </div>
              ...
              <div className="row">
                <h1 className="mt-5">Lista de CNPJ's mais atritados - Geral</h1>            
              </div>
